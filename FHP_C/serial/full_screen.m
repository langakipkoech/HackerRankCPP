...
% Initialize the figure to cover the entire screen
figure('Units', 'normalized', 'OuterPosition', [0, 0, 1, 1]); % Fullscreen figure
hold on;
axis equal;
set(gca, 'XLim', [-1, N+1] * 1.5, 'YLim', [-1, M+1] * sqrt(3)); % Set expanded axis limits
set(gca, 'Color', 'white'); % Background color
axis off; % Remove axis decorations
...
video_filename = "fhp_simulation_animation_fullscreen.mp4";
...
disp("Animation saved as fhp_simulation_animation_fullscreen.mp4");
